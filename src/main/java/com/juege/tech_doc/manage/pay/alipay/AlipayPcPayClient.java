...
public class AlipayPcPayClient extends AbstractAlipayPayClient {
	...
	public AlipayPcPayClient(AlipayPayClientConfig config) {
		super(PayChannelEnum.ALIPAY_PC.getCode(), config);
	}

	@Override
	public PayRespDTO doUnifiedOrder(PayUnifiedReqDTO reqDTO) throws AlipayApiException {
		...
		model.setQrPayMode("0"); // 跳转模式 - 订单码，效果参见：https://help.pingxx.com/article/1137360/
		...
		return PayRespDTO.waitingOf(displayMode, response.getBody(),
